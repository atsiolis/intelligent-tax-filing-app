...
def get_tax_advice(data: TaxFormData):
    """
    Receives tax form data from the frontend and returns advice.
    Returns a hardcoded response.
    This will call OpenAI and return AI-generated advice.
    """
    ...
    # --- Hardcoded response (will be replaced in Step 3) ---
    advice = (
